...
const ThemeMenu = () => {
    ...
    useEffect(() => {
        ...
        const themeClass = mode_settings.find(event => event.class === localStorage.getItem('themeMode'))
        const colorClass = color_settings.find(event => event.class === localStorage.getItem('colorMode'))
